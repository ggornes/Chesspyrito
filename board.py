...
class Board:
    ...
    def validate_move(self, uci_move):
    ...
    def board_to_list_of_list(self):
        ...
        list_of_list_board =[utils.split_string_to_chars(l) for [l] in list_of_list_board1]
    ...
    def parse_square_to_list_index_position(self,  square: str):
        ...
        """
        file = utils.split_string_to_chars(square)[0]
        rank = utils.split_string_to_chars(square)[1]
        x = 8 - int(rank)
        y = ord(file) - 97
